...
assert(chat.includes("operatorBriefing.projects.length"), "Operator briefing summarizes project count");
assert(chat.includes("operatorBriefing.proposals.length"), "Operator briefing summarizes proposal count");
